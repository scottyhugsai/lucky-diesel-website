  ...
  return (
    <div className="pb-24 pt-32 sm:pt-40">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        {posts.length === 0 ? (
          <p className="mt-14 rounded-md border border-line bg-carbon-2 p-6 text-chalk/70">
            First posts are on the way. Questions now? Call <a href={BUSINESS.phoneHref} className="text-clover underline-offset-4 hover:underline">{BUSINESS.phoneDisplay}</a>.
          </p>
        ) : (
